      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{$dimension->nombreDimension}}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <br>
        <div class="btn-group">
          <a class="btn btn-info" href="{{route('dimensiones.index')}}">
            {!! helper_FormatoBotonCRUD(7, 'texto') !!}
          </a>
          <a class="btn btn-warning" href="{{route('dimensiones.edit',$dimension->idDimension)}}">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Dimension</label>
              <div class="col-md-10">
                <p class="form form-control">{{$dimension->nombreDimension}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Puntaje Máximo</label>
              <div class="col-md-10">
                <p class="form form-control">{{$dimension->puntajeMaximo}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Tipo de Cálculo</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_FormatoAtributoValorATexto($dimension->tipoCalculo, 'dimensionTipoCalculo')}}</p>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Gestión</label>
              <div class="col-md-10">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <p class="form form-control">{{$dimension->fechaRegistro}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Actualizacion</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_formatoNullorEmpty($dimension->fechaActualizacion)}}</p>
              </div>
            </div>
            <div class="form-group row">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="font-weight-bold">{{$dimension->nombreDimension}}</p>
        </div>
        <div class="modal-footer justify-content-between">
          ...
          <form action="{{route('dimensiones.delete')}}" method="POST">
            @csrf
            @method('put')
            <input type="hidden" name="idDimension" value="{{$dimension->idDimension}}">
