  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">{{$Titulos.': '.$gestion->anhoGestion}}</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('gestiones.update',$gestion)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <input type="number" class="form-control @error('anhoGestion') is-invalid @enderror"
                    name="anhoGestion" value="{{old('anhoGestion',$gestion->anhoGestion)}}" placeholder="GESTION" min="2000" max="2040" required autofocus>
                  </div>
                  @error('anhoGestion')
