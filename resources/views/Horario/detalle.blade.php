 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">HORARIO - {{$asignatura->nombreAsignatura}}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('usuarios.index')}}">INICIO</a></li>
            <li class="breadcrumb-item"><a href="{{route('horarios.index')}}">HORARIOS</a></li>
            <li class="breadcrumb-item active">{{$horario->nombreHorario}}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <br>
        <div class="btn-group">
          <a class="btn btn-info" href="{{route('horarios.index')}}">
            {!! helper_FormatoBotonCRUD(7, 'texto') !!}
          </a>
          <a class="btn btn-warning" href="{{route('horarios.edit',$horario->idHorario)}}">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Día</label>
              <div class="col-md-10">
                <p class="form form-control">{{ helper_FormatoAtributoValorATexto($horario->dia, 'horarioDia') }}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Hora Inicio</label>
              <div class="col-md-10">
                <p class="form form-control">{{$horario->horaInicio}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Hora Fin</label>
              <div class="col-md-10">
                <p class="form form-control">{{$horario->horaFin}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Registro</label>
              <div class="col-md-10">
                <p class="form form-control">{{$horario->fechaRegistro}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Actualizacion</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_formatoNullorEmpty($horario->fechaActualizacion)}}</p>
              </div>
            </div>
            <div class="form-group row">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="font-weight-bold">{{$asignatura->nombreAsignatura . ' - ' . helper_FormatoAtributoValorATexto($horario->dia, 'horarioDia') . ' DE ' . $horario->horaInicio . ' A ' . $horario->horaFin}}</p>
        </div>
