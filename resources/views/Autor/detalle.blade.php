 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">{{$nombreAutor}}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">INICIO</a></li>
            <li class="breadcrumb-item"><a href="{{route('autores.index')}}">AUTORES</a></li>
            <li class="breadcrumb-item active">{{$nombreAutor}}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-body">
        <h3 class="card-title font-weight-bold">LIBROS CON EL AUTOR "{{$nombreAutor}}": <span class="text-info">{{ count($Libros) }}</span> REGISTROS.</h3>
        <br><br>
        <div class="col-md-12">
