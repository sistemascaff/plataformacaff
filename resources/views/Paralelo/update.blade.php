  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">{{$Titulos.': '.$paralelo->nombreParalelo}}</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('paralelos.update',$paralelo)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" name="nombreParalelo" value="{{$paralelo->nombreParalelo}}" placeholder="PARALELO" minlength="1" maxlength="45" required autofocus>
                  </div>
                </div>
              </div>
