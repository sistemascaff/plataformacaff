 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">{{$editorial->nombreEditorial}}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('usuarios.index')}}">INICIO</a></li>
            <li class="breadcrumb-item"><a href="{{route('editoriales.index')}}">EDITORIALES</a></li>
            <li class="breadcrumb-item active">{{$editorial->nombreEditorial}}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <br>
        <div class="btn-group">
          <a class="btn btn-info" href="{{route('editoriales.index')}}">
            {!! helper_FormatoBotonCRUD(7, 'texto') !!}
          </a>
          <a class="btn btn-warning" href="{{route('editoriales.edit',$editorial->idEditorial)}}">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <p class="form form-control">{{$editorial->nombreEditorial}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Registro</label>
              <div class="col-md-10">
                <p class="form form-control">{{$editorial->fechaRegistro}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Actualizacion</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_formatoNullorEmpty($editorial->fechaActualizacion)}}</p>
              </div>
            </div>
            <div class="form-group row">
        ...
        <h3 class="card-title font-weight-bold">LIBROS PERTENECIENTES A {{$editorial->nombreEditorial}}:</h3>
        <br><br>
        <div class="col-md-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="font-weight-bold">{{$editorial->nombreEditorial}}</p>
        </div>
