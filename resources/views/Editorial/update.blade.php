  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">{{$Titulos.': '.$editorial->nombreEditorial}}</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('editoriales.update',$editorial)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">NOMBRE EDITORIAL <span class="text-danger">(*)</span></label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control @error('nombreEditorial') is-invalid @enderror"
                    name="nombreEditorial" value="{{old('nombreEditorial',$editorial->nombreEditorial)}}" placeholder="EDITORIAL" minlength="1" maxlength="100" required autofocus>
                  </div>
