  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">{{$Titulos.': '.$coordinacion->nombreCoordinacion}}</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('coordinaciones.update',$coordinacion)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control @error('nombreCoordinacion') is-invalid @enderror" name="nombreCoordinacion" value="{{old('nombreCoordinacion', $coordinacion->nombreCoordinacion)}}" placeholder="COORDINACION" minlength="3" maxlength="45" required autofocus>
                  </div>
