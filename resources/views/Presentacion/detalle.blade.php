      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{$presentacion->nombrePresentacion}}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <br>
        <div class="btn-group">
          <a class="btn btn-info" href="{{route('presentaciones.index')}}">
            {!! helper_FormatoBotonCRUD(7, 'texto') !!}
          </a>
          <a class="btn btn-warning" href="{{route('presentaciones.edit',$presentacion->idPresentacion)}}">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <p class="form form-control">{{$presentacion->nombrePresentacion}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Registro</label>
              <div class="col-md-10">
                <p class="form form-control">{{$presentacion->fechaRegistro}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Actualizacion</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_formatoNullorEmpty($presentacion->fechaActualizacion)}}</p>
              </div>
            </div>
            <div class="form-group row">
        ...
        <h3 class="card-title font-weight-bold">LIBROS PERTENECIENTES A {{$presentacion->nombrePresentacion}}:</h3>
        <br><br>
        <div class="col-md-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="font-weight-bold">{{$presentacion->nombrePresentacion}}</p>
        </div>
        <div class="modal-footer justify-content-between">
          ...
          <form action="{{route('presentaciones.delete')}}" method="POST">
            @csrf
            @method('put')
            <input type="hidden" name="idPresentacion" value="{{$presentacion->idPresentacion}}">
