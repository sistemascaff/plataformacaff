  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">{{$Titulos.': '.$aula->nombreAula}}</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('aulas.update',$aula)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">NOMBRE AULA (*)</label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control @error('nombreAula') is-invalid @enderror"
                    name="nombreAula" value="{{old('nombreAula',$aula->nombreAula)}}" placeholder="AULA" minlength="1" maxlength="65" required autofocus>
                  </div>
                  @error('nombreAula')
