            ...
            <form class="form-horizontal" action="{{route('librosprestamos.update',$libroprestamo)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">LECTOR <span class="text-danger">(*)</span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">CELULAR <span class="text-danger">(*)</span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">FECHA DE DEVOLUCIÓN <span class="text-danger">(*)</span></label>
                  <div class="col-sm-10">
