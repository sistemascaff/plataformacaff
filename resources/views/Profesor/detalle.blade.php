        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <a href="@if($nivel->idNivel != 0)
                  {{route('niveles.details', $nivel->idNivel)}}
                  @else
                  #
                  @endif" class="form form-control font-weight-bold">{{$nivel->nombreNivel}}</a>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">COORDINADOR/A</label>
              <div class="col-md-8">
                <a href="@if($coordinacion->idCoordinacion != 0)
                  {{route('coordinaciones.details', $coordinacion->idCoordinacion)}}
                  @else
                  #
                  @endif" class="form form-control font-weight-bold">{{$coordinacion->nombreCoordinacion}}</a>
              </div>
            </div>
            <div class="form-group row">
