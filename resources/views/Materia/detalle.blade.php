      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{$materia->nombreMateria}}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <br>
        <div class="btn-group">
          <a class="btn btn-info" href="{{route('materias.index')}}">
            {!! helper_FormatoBotonCRUD(7, 'texto') !!}
          </a>
          <a class="btn btn-warning" href="{{route('materias.edit',$materia->idMateria)}}">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <p class="form form-control">{{$materia->nombreMateria}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Abreviatura</label>
              <div class="col-md-10">
                <p class="form form-control">{{$materia->nombreCorto}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Tipo de Materia</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_FormatoAtributoValorATexto($materia->tipoMateria,'materiaTipoMateria')}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Area</label>
              <div class="col-md-10">
                <a href="{{route('areas.details', $area->idArea)}}" class="form form-control font-weight-bold">{{$area->nombreArea}}</a>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Registro</label>
              <div class="col-md-10">
                <p class="form form-control">{{$materia->fechaRegistro}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Actualizacion</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_formatoNullorEmpty($materia->fechaActualizacion)}}</p>
              </div>
            </div>
            <div class="form-group row">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="font-weight-bold">{{$materia->nombreMateria}}</p>
        </div>
