      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('materiales.index')}}">INICIO</a></li>
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">MATERIALES</h3>
      </div>
      <div class="card-body">
        <a href="{{route('materiales.create')}}" class="btn btn-success">{!! helper_FormatoBotonCRUD(1, 'texto') !!}</a>
        <br><br>
        ...
        @if ($busqueda)
          <h3 class="font-weight-bold">
            ...
            <a href="{{route('materiales.index')}}" class="btn btn-secondary">{!! helper_FormatoBotonCRUD(6, 'icono') !!}</a>
          </h3>
          <br>
        @endif
        <!-- / Formulario de búsqueda -->
              ...
              <tbody>
                @foreach ($tableMaterial as $rowMaterial)
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-info" href="{{route('materiales.details', $rowMaterial->idMaterial)}}">
                          {!! helper_FormatoBotonCRUD(2, 'icono') !!}
                        </a>
                        <a class="btn btn-warning" href="{{route('materiales.edit',$rowMaterial->idMaterial)}}">
                          {!! helper_FormatoBotonCRUD(3, 'icono') !!}
                        </a>
                        <a class="btn btn-danger eliminar-registro" data-toggle="modal" data-target="#modalDelete" data-id="{{$rowMaterial->idMaterial}}" data-nombre="{{$rowMaterial->nombreMaterial}}">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <form action="{{route('materiales.delete')}}" method="POST">
            @csrf
            @method('put')
            <input type="hidden" id="id" name="idMaterial" value="0">
