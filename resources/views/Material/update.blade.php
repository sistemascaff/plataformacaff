  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('materiales.update',$material)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <input type="text" class="form-control @error('nombreMaterial') is-invalid @enderror"
                    name="nombreMaterial" value="{{old('nombreMaterial',$material->nombreMaterial)}}" placeholder="MATERIAL" minlength="1" maxlength="100" required autofocus>
                  </div>
