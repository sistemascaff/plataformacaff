 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="font-weight-bold">{{$categoria->nombreCategoria}}</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="btn-group">
          ...
          <a class="btn btn-warning" href="{{route('categorias.edit',$categoria->idCategoria)}}">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <p class="form form-control">{{$categoria->nombreCategoria}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Registro</label>
              <div class="col-md-10">
                <p class="form form-control">{{$categoria->fechaRegistro}}</p>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputEmail3" class="col-md-2 col-form-label">Fecha de Actualizacion</label>
              <div class="col-md-10">
                <p class="form form-control">{{helper_formatoNullorEmpty($categoria->fechaActualizacion)}}</p>
              </div>
            </div>
            <div class="form-group row">
        ...
        <h3 class="card-title font-weight-bold">LIBROS PERTENECIENTES A {{$categoria->nombreCategoria}}:</h3>
        <br><br>
        <div class="col-md-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="font-weight-bold">{{$categoria->nombreCategoria}}</p>
        </div>
