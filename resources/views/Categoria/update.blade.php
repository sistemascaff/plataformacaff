  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title font-weight-bold">{{$Titulos.': '.$categoria->nombreCategoria}}</h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <form class="form-horizontal" action="{{route('categorias.update',$categoria)}}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">NOMBRE CATEGORIA <span class="text-danger">(*)</span></label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control @error('nombreCategoria') is-invalid @enderror"
                    name="nombreCategoria" value="{{old('nombreCategoria',$categoria->nombreCategoria)}}" placeholder="CATEGORIA" minlength="1" maxlength="100" required autofocus>
                  </div>
              ...
              <a href="{{route('categorias.index')}}" class="btn btn-secondary">{!! helper_FormatoBotonCRUD(6, 'texto') !!}</a>
