...
greyscale:!1,i18n:{add:"Añadir Condición",button:{0:"Constructor de Búsqueda",_:"Constructor de Búsqueda (%d)"},clearAll:"Limpiar Todo",condition:"Condición",data:"Columna","delete":"&times",deleteTitle:"Delete filtering rule",left:"<",leftTitle:"Desanidar criterio",logicAnd:"Y",logicOr:"O",right:">",rightTitle:"Anidar criterio",title:{0:"Búsqueda Personalizada",_:"Búsqueda Personalizada (%d)"},value:"Valor",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};return c}(),B,E,G=function(){function c(a,
...
enterSearch:!1,filterChanged:void 0,greyscale:!1,i18n:{add:"Añadir Condición",button:{0:"Constructor de Búsqueda",_:"Constructor de Búsqueda (%d)"},clearAll:"Limpiar Todo",condition:"Condición",data:"Columna","delete":"&times",deleteTitle:"Delete filtering rule",left:"<",leftTitle:"Desanidar criterio",logicAnd:"Y",logicOr:"O",right:">",rightTitle:"Anidar criterio",title:{0:"BÚSQUEDA PERSONALIZADA",_:"BÚSQUEDA PERSONALIZADA (%d)"},value:"Valor",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};
...
"html-num-fmt":r.numFmtConditions,luxon:r.luxonDateConditions,moment:r.momentDateConditions,num:r.numConditions,"num-fmt":r.numFmtConditions,string:r.stringConditions},depthLimit:!1,enterSearch:!1,filterChanged:void 0,greyscale:!1,i18n:{add:"Añadir Condición",button:{0:"Constructor de Búsqueda",_:"Constructor de Búsqueda (%d)"},clearAll:"Limpiar Todo",condition:"Condición",conditions:{array:{contains:"CONTIENE",empty:"ESTÁ VACÍO",equals:"EQUIVALE A",not:"EXCEPTO",notEmpty:"NO ESTÁ VACÍO",without:"SIN"},date:{after:"DESPUÉS",before:"ANTES",
between:"ENTRE",empty:"ESTÁ VACÍO",equals:"EQUIVALE A",not:"EXCEPTO",notBetween:"NO ENTRE",notEmpty:"NO ESTÁ VACÍO"},number:{between:"ENTRE",empty:"ESTÁ VACÍO",equals:"EQUIVALE A",gt:"MAYOR QUE",gte:"MAYOR O IGUAL QUE",lt:"MENOR QUE",lte:"MENOR O IGUAL QUE",not:"EXCEPTO",notBetween:"NO ENTRE",notEmpty:"NO ESTÁ VACÍO"},string:{contains:"CONTIENE",empty:"ESTÁ VACÍO",endsWith:"TERMINA CON",equals:"EQUIVALE A",not:"EXCEPTO",notContains:"NO CONTIENE",notEmpty:"NO ESTÁ VACÍO",notEndsWith:"NO TERMINA CON",notStartsWith:"NO COMIENZA CON",
startsWith:"COMIENZA CON"}},data:"Columna","delete":"&times",deleteTitle:"Borrar regla de filtro",left:"<",leftTitle:"Desanidar criterio",logicAnd:"Y",logicOr:"O",right:">",rightTitle:"Anidar criterio",title:{0:"BÚSQUEDA PERSONALIZADA",_:"BÚSQUEDA PERSONALIZADA (%d)"},value:"Valor",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};return c}();(function(c){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return c(a,window,document)}):
