...
greyscale:!1,i18n:{add:"Añadir Condición",button:{0:"Constructor de Búsqueda",_:"Constructor de Búsqueda (%d)"},clearAll:"Limpiar Todo",condition:"Condición",data:"Columna","delete":"&times",deleteTitle:"Delete filtering rule",left:"<",leftTitle:"Outdent criteria",logicAnd:"Y",logicOr:"O",right:">",rightTitle:"Indent criteria",title:{0:"Búsqueda Personalizada",_:"Búsqueda Personalizada (%d)"},value:"Valor",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};return c}(),B,E,G=function(){function c(a,
...
between:"Between",empty:"ESTÁ VACÍO",equals:"EQUIVALE A",not:"EXCEPTO",notBetween:"Not Between",notEmpty:"NO ESTÁ VACÍO"},number:{between:"Between",empty:"ESTÁ VACÍO",equals:"EQUIVALE A",gt:"Greater Than",gte:"Greater Than Equal To",lt:"Less Than",lte:"Less Than Equal To",not:"EXCEPTO",notBetween:"Not Between",notEmpty:"NO ESTÁ VACÍO"},string:{contains:"CONTIENE",empty:"ESTÁ VACÍO",endsWith:"TERMINA CON",equals:"EQUIVALE A",not:"EXCEPTO",notContains:"NO CONTIENE",notEmpty:"NO ESTÁ VACÍO",notEndsWith:"NO TERMINA CON",notStartsWith:"NO COMIENZA CON",
startsWith:"COMIENZA CON"}},data:"Columna","delete":"&times",deleteTitle:"Delete filtering rule",left:"<",leftTitle:"Outdent criteria",logicAnd:"Y",logicOr:"O",right:">",rightTitle:"Indent criteria",title:{0:"BÚSQUEDA PERSONALIZADA",_:"BÚSQUEDA PERSONALIZADA (%d)"},value:"Valor",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};return c}();(function(c){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return c(a,window,document)}):
